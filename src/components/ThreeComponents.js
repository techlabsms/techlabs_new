              ...
              <div className="col-md-4">
                ...
                >
                  ...
                  <p className="align-self-center">
                    ...
                    make sure that both a coding beginner or already experienced
                    techie can learn something new in our program, we
                    individualize our participant’s learning paths based on
              ...
              <div className="col-md-4">
                <div className="threeComponents--circle threeComponents--circle_3  d-flex justify-content-center">
                  ...
                  <p className="align-self-center">
                    ...
                    groups in case of technical issues and questions regarding
                    the project scope or project management.
                  </p>
                </div>
              </div>
            </div>
