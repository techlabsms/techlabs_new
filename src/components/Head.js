  ...
  render() {
    return (
      <>
        ...
        <meta property="twitter:title" content="TechLabs - We Build. Digital. Shapers."/>
        <meta property="twitter:description" content="TechLabs is a platform for young people from all disciplines. We provide state-of-the-art Tech-Skills to solve the problems of our time digitally and entrepreneurially"/>  
